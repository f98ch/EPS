...
``medidor'' \cpnote{las comillas dobles son problematicas en Latex. Checa por ahi en 
internet como se hace. Ahora ya corregi estas y no encontre mas, pero cuidado
si las quieres usar de nuevo.}
...
reales\cpnote{porque necesitamos este principio para implemtnar circuitos?}.
A continuación, usaremos la definición \cpnote{Es una definicion, o un principio?}
 de Nielsen y Chuang
\cite{nielsen_chuang_2011}:
%
...
\end{prin}
\cpnote{No recuerod donde usas eso en tu trabajo. Me lo puedes señalar?}
...
capacidad de hasta 5000 qubits \cpnote{dudo este numero. tienes alguna referencia?}. También podemos correr los circuitos en
computadoras cuánticas reales,  con capacidad de hasta 7 qubits de forma
gratuita\cpnote{Checa, no se si siga siendo gratuito y no se si ese numero de 7 está 
actualizado}. En este trabajo haremos uso de los servicios gratuitos en la
plataforma. 
