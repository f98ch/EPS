...
escribiendo.} $|c_i|^2$ representa la probabilidad de que, al medir el sistema, el
estado colapse al $i$-ésimo vector $\ket{i}$ de la base. \cpnote{Al ser medido
...
bien. }\cpnote{Aun no entiendes el punto. Da lo mismo medir cualquier observable?}
...
para introducir los canales (linea 330).}\cpnote{Ahora que estoy quitando comentarios se mueve
todo. Busque odnde haces referencia a esta ecuacion pero no encuentro. Quizá si en vez de 
referir una linea, refieres una ecuacion es mas facil de encontrar}.
