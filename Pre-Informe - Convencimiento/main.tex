...
% Intro {{{
\cpnote{Falta una miniintro que puede ser de un par de frases posiblemente diciendo lo que vas a 
hablar y porque. } 

% }}}
\subsection{Compuertas y mediciones cuánticas} % {{{

\cpnote{Revisa redaccion}
...
\textbf{Fuente:} Nielsen y Chuang \cite{nielsen_chuang_2011}.}
    \label{fig:Bloch}
\end{figure}
La representación de un qubit en la esfera de Bloch, se describe por medio de
la ecuación\cpnote{esta frase no tiene sentido. porque dices quue vamos a describir una representacion???}: 
\begin{equation}
    \label{ec:Bloch_rep}
