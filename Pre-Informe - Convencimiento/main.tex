...
Hemos propuesto utilizar los VQA para inicializar un canal cuántico mediante su matriz de Choi $\Lambda_{\mathcal{E}}$, de tal forma que su fidelidad de proceso se asemeje a la del canal deseado. Para nuestro estudio, hemos seleccionado el \textit{Depolarizing Channel}, simulándolo para diferentes valores de $p$. Para verificar la precisión de nuestro método, implementamos la matriz de Choi obtenida con el VQA en una computadora cuántica y en un simulador. Finalmente comparamos sus fidelidades con la matriz de Choi esperada del canal cuántico.
