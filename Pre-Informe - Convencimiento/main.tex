...
si las quieres usar de nuevo.} \felnote{Muchas gracias. Si gustas puedo cambiarlo mejor a comilla simple?}
...
El circuito cuántico mostrado en la figura \ref{fig:circuito7} aplica una compuerta $Z$ al qubit $q_3$ y luego una compuerta $CNOT$ entre los qubits $q_3$ y $q_0$. De manera similar, los qubits $q_2$ y $q_0$ interactúan a través de otra compuerta $CNOT$. Supongamos que buscamos ejecutar este circuito en la computadora cuántica con la topología de la figura \ref{fig:circuito7}. Ya que los qubits $q_0,q_3$ y $q_0,q_2$ no interaccionan directamente, debemos reescribir nuestro circuito para esta topología. La transpilación resultante se puede ver en la figura \ref{fig:circuito8}).  
