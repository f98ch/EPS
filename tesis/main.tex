...
entre los entornos ideal y real, el impacto de la despolarización sobre la
fidelidad y los autovalores de las matrices de Choi, así como las limitaciones
inherentes al hardware utilizado. Esta discusión permite evaluar el desempeño
de los algoritmos variacionales en la implementación de canales cuánticos en
computadoras cuánticas y llegar a una conclusión respecto a los objetivos
planteados en el proyecto. 

\cpnote{Es importante aca mencionar los resultados también. Como un pequeño trailer. }
% }}}
