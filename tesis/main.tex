...
\cpnote{Hablar de esta frase anterior}. En respuesta a estos desafíos, una de
las estrategias más
...
de optimización clásica. Este enfoque híbrido ha mostrado ser eficaz para
...
VQA. Con este objetivo, se estudiarán, en la primera parte del trabajo, los
...
Posteriormente, se construirá un VQA usando un \textit{hardware efficient
...
Este proceso se llevará a cabo tanto en un simulador como en una computadora
cuántica real, lo que permitirá comparar el rendimiento ideal con el
comportamiento en dispositivos actuales. Finalmente, se analizarán los
...
distintas ejecuciones. Estos resultados permitirán evaluar el impacto del ruido
y las limitaciones del hardware cuántico. Con base en ello, se propondrán
